...
const UpdateUserSchema = Yup.object().shape({
    businessAddress: Yup.string().min(3, 'address must be at least 3 characters').required('First Name is required'),
...
const EditUserBusinessAddressForm = () => {
                ...
                {({ values, touched, errors, isSubmitting }) => {
                    return (
                        <Form>
                            <FormContainer>
                                <div>
                                    <h4 className='py-2'>Business Address :</h4>
                                    <div className='flex gap-0 justify-between flex-col sm:flex-row sm:gap-4'>
                                        <FormItem
                                            extra={asterisk}
                                            label="Business Address"
                                            invalid={errors.businessAddress && touched.businessAddress}
...
export default EditUserBusinessAddressForm
